...
data_imdb = pd.read_csv(r"C:\Users\pardhavi\Desktop\Acadamic Projects\sentiment_analysis\sentiment_analysis\Datasets\imdb_labelled.txt", sep="\t", header=None)
data_imdb.columns = ['text', 'sentiment']

# Dataset 2: Yelp Dataset
data_yelp = pd.read_csv(r"C:\Users\pardhavi\Desktop\Acadamic Projects\sentiment_analysis\sentiment_analysis\Datasets\yelp_labelled.txt", sep="\t", header=None)
data_yelp.columns = ['text', 'sentiment']

# Dataset 3: Amazon Cells Dataset
data_amazon = pd.read_csv(r"C:\Users\pardhavi\Desktop\Acadamic Projects\sentiment_analysis\sentiment_analysis\Datasets\amazon_cells_labelled.txt", sep="\t", header=None)
